sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.endUserApp.controller.Addopleiding", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Addopleiding").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
